    ...
    <div className="relative h-[85vh] w-full bg-[#141414] lg:h-[95vh] overflow-hidden">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Content Container */}
          <div className="relative z-10 flex h-full flex-col justify-center space-y-4 px-4 lg:px-16 pt-20">
            <motion.div 
            ...
            <motion.h1 
              ...
              className="text-4xl font-extrabold text-white md:text-6xl lg:text-8xl max-w-4xl drop-shadow-2xl"
            >
            ...
            <motion.p 
              ...
              className="max-w-xs text-sm text-white/90 drop-shadow-md md:max-w-lg md:text-xl lg:max-w-2xl line-clamp-3"
            >
              {movie?.overview}
            </motion.p>
            ...
            >
              <button 
                onClick={handlePlay}
                className="flex items-center gap-x-3 rounded-md bg-white px-6 py-2.5 text-lg font-bold text-black transition-all hover:bg-white/80 active:scale-95 shadow-lg"
              >
                <Play className="h-6 w-6 fill-current" /> Play
              </button>
              <button className="flex items-center gap-x-3 rounded-md bg-[#6d6d6eb3] px-6 py-2.5 text-lg font-bold text-white transition-all hover:bg-[#6d6d6e66] active:scale-95 shadow-lg backdrop-blur-md">
